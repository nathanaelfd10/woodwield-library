...
<div class="jumbotron jumbotron-browse text-light text-center">
  <h1 class="jumbotron-header"><?php echo $_SESSION['login_user']?></h1>
  <form action="signup.php" method="POST">
      <div class="modal-body">
        <div class="form-group">
            <?php 
        echo "<img class='pic' src='images/user/".$_SESSION['pic']."' style='width:15vh; border-radius:100%; height:auto;'>";
        ?>
        </div>
