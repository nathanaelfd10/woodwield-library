...
<div class="jumbotron jumbotron-browse text-light text-center">
  <h1 class="jumbotron-header">Sign Up</h1>
</div>

<div class="push-right" style="margin-left:10vh;">
  <h2 class="jumbotron-subtitle" style="color:#fff;">Create an account to manage</h2>
  ...
  <form action="signup.php" method="POST">
      ...
      <tr>
        <div class="form-group">
            <input type="text" name = "username" class="form-control" placeholder="Woodwield ID" style="width:20vh">
        </div>
        </tr>
        <tr>
        <div class="form-group">
            <input type="password" name = "password" class="form-control" placeholder="Password" style="width:20vh">
        </div>
        </tr>
        <tr>
        <div class="form-group">
            <input type="text" name = "user_email" class="form-control" placeholder="Email" style="width:20vh">
        </div>
        </tr>

    

        <button type="submit" name="signup" class="btn btn-primary" style="margin-bottom:5vh;">Sign Up</button>
      </div>
      </form>
</table>
</div>
